...
<template>
  <div>
    ...
    >
      <div>
        <div
          class="flex w-full bg-white rounded-lg shadow dark:border dark:bg-gray-800 dark:border-gray-700 flex-row flex-wrap h-full"
        >
          <div
            class="flex p-6 space-y-4 md:space-y-6 sm:p-8 flex-auto flex-wrap justify-center justify-items-center content-center pt-50"
          >
